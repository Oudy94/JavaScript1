...
let grade = 60; // Here we assign the student mark as a parameter to the calcGrades function to calculate the student grade

function calcGrades(grade){
    
    if (grade >= 90) //Check if the mark is 90 or more 
        return `you got a A (${grade}%)!`; //calulate the student grade
